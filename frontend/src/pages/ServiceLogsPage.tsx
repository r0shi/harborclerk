...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="ml-2 shrink-0 rounded-sm px-1.5 py-0.5 text-xs font-medium bg-(--color-bg-tertiary) text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors"
