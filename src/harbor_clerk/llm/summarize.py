...
_SYSTEM_PROMPT = (
    "Summarize the following document excerpt in 1-2 sentences. Be concise."
)
...
def generate_summary(chunks_text: str, max_chars: int | None = None) -> str:
    ...
    return _extractive_fallback(input_text, max_chars)
