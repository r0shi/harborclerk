...
- **Run id:** `ix-4` · commit `v0.9.2-24-g205667e` · window: releases since 2026-07-22 · 27 vendors watched
...
Screened only because no trusted Q4_K_M build exists yet. The next survey examines these again although they will be older than its window. A release drops off 120 days after it was published.
...
{
 "format": 1,
 "generated_at": "2026-09-17T18:24:29+00:00",
 "inputs": {
  "carried": [],
  "known_orgs": null
 },
