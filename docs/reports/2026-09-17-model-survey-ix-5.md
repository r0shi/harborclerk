...
- **Run id:** `ix-5` · commit `v0.9.2-27-gc238ccf` · window: releases since 2026-07-22 · 27 vendors watched
- **Previous survey:** none · 0 release(s) carried into this run, 0 examined again (the rest are excluded now, or gone) · the window overlaps earlier runs by 30 days, and 0 release(s) they examined were skipped
...
**Coverage.** 52 releases examined, none over the per-vendor cap. NVIDIA publishes Nemotron 3.5 Lightning only as a
...
{
 "format": 1,
 "generated_at": "2026-09-17T18:50:24+00:00",
 "inputs": {
  "carried": [],
