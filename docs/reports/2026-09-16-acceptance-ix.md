# Acceptance run — 2026-09-16 — ix

- **Suite commit:** `3008835`
...
- **Run id:** `live15` · duration 366 s · 47 passed, 2 xfailed
...
| Search and Find All | partial | c1 ✓, c2 ✓, c3 ✓, c4 ✓, c5 ✓, c6 ✓, c7 ✓, c8 ✓, h1 ✓, h1c xfail, h1b ✓ |
...
- **h1c** (xfailed): #621 follow-up (v0.9.2 known limitation): REST passages/read still dereferences a deleted chunk by id
